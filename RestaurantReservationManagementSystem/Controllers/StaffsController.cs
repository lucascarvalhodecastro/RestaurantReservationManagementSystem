...
namespace RestaurantReservationManagementSystem.Controllers
{
    ...
    public class StaffsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StaffID,Name,Email,Role,Password")] Staff staff)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StaffID,Name,Email,Role,Password")] Staff staff)
        {
            if (id != staff.StaffID)
            {
                return NotFound();
